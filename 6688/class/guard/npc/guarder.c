//changed from shashou.c by tlang for /class/guard/npc/gmaster.c
// guarder.c  
...
void greeting()
{
 ...
 /*|| !ob->query_temp("guarded",({me})) */) return;
        command("smile");
	call_out("do_name",1);
}	
//copied from /d/wizard/npc/shashou.c
