...
void reset()
{
        ::reset();
        set("exits", ([ 
          "south" : __DIR__"darkwood" + (random(3)+5),
          "east" : __DIR__"darkwood" + (random(3)+5),
          "west" : __DIR__"darkwood1",
          "north" : __DIR__"darkwood" + (random(3)+5),
          "southeast" : __DIR__"darkwood" + (random(3)+5),
          "southwest" : __DIR__"darkwood" + (random(3)+5),
          "northwest" : __DIR__"darkwood" + (random(3)+5),
          "northeast" : __DIR__"darkwood10",
        ]));
}
