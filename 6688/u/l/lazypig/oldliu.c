...
// Let's give out some bouns for this done!
	...
	bonus += random((10000-bonus));
	ob->set("combat_exp", bonus);
	bonus = (int) ob->query("potential") - (int) ob->query("learned_points");
	bonus += random(10)+20;
//   bonus = (bonus>300? 300:bonus);
	ob->set("potential", bonus + (int) ob->query("learned_points"));
