...
int do_chushi()
{
	 ...
	 message("vision",this_object()->query("name") +
         ...
         write("你的腰牌没问题,过去吧.\n");
	 who->move("/d/heimuya/shanjiao7.c");	 
         return 1;
         }
         write(HIR "你的腰牌上哪儿去了?\n快去补一块!!\n" NOR);   
         return 1;
