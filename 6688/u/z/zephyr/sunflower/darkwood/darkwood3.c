...
void reset()
{
        ::reset();
        set("exits", ([ 
          "south" : __DIR__"darkwood" + (random(3)+4),
          "east" : __DIR__"darkwood" + (random(3)+4),
          "west" : __DIR__"darkwood" + (random(3)+4),
          "north" : __DIR__"darkwood" + (random(3)+4),
          "southeast" : __DIR__"darkwood" + (random(3)+4),
          "southwest" : __DIR__"darkwood" + (random(3)+4),
          "northwest" : __DIR__"darkwood2",
          "northeast" : __DIR__"darkwood5",
        ]));
}
