...
int effective_level()
{
        if( this_player()->query_skill("jiayiforce",1) > 199 )
		return 28;
	if( this_player()->query_skill("jiayiforce",1) > 180 )
		return 14;	
	return 10;
}
...
int exercise_speed()
{
	if( this_player()->query_skill("jiayiforce",1) > 190 )
		return 5;
	if( this_player()->query_skill("jiayiforce",1) > 180 )
		return 8;	             
	return 10;
