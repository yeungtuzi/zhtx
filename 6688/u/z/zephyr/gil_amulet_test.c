        ...
        {       
                if( me->is_fighting() && (gil) && !me->query_condition("zhaohuan_weaponor" ) )
                {
                        ...
                        {       
								...
								me->apply_condition("zhaohuan_weaponor", 5+random(15) );
                ...
                if( !living(me) && (wake) )
                {
                        ...
                        if( random(100)>60 && random(player_gil_flag) > 1500)
                        {
...
int do_feel(string arg)
{
	...
	int value = 25 * (player_gil_flag - 450) /  player_gil_flag;
	int w = 40 * (player_gil_flag - 1500) /  player_gil_flag;
