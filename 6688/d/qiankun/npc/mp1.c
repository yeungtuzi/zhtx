...
HIG"“听说我的师兄地狱圣火后来归隐去了侠客岛，如果有机会的话将来你去找他”\n",NOR,
...
void create()
{
        ...
        create_family("茅山派", 2, "无名前辈");
        set("title", HIB"乾坤教囚徒"NOR);
        set("nickname",HIR "逝去的辉煌，永世的神伤"NOR);
        setup();

        carry_object("/d/qiankun/obj/weapon/an-ling")->wield();
}
...
{        
        object weapon = new("/d/qiankun/obj/weapon/an-ling");       
        object ob;        
