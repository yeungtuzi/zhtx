...
string *rnd_id = ({"wang","ma","ta","pu","gu","du","lan","dong","xi","li","zhou","ge","huang"});
string *rnd_id_tail = ({"lh","gh","ss","h","le","d","ck","m","tte"});
...
varargs void drool(string msg, string who)
{
	...
	||	(strsrch(msg, "Drooler") >= 0)) {
		...
		switch(random(20)) {
			...
			case 17: command("chat 有这样的事吗？我怎么不知道啊？"); break;
			case 18: command("chat 大家不要相信" + who->query("id") + "的话，他在胡说八道。"); break;
			case 19: command("chat 我这儿有，谁想要啊？"); break;
			default:
				break;
		}
	}
