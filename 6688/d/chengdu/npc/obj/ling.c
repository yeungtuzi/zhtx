...
void create()
{
	...
	if( clonep() )
		...
		set("value", 0);
		set("material", "steel");
		set("long", "这是七种武器之一,威力惊人的孔雀翎。\n");
		set("wield_msg", "$N从腰边的皮套里掏出一个$n握在手中。\n");
		set("unequip_msg", "$N将手中的$n放回腰间的皮套里。\n");
	}
	init_blade(100);
	setup();
}
...
int do_aim(string arg)
{
	...
	if( this_object()->query("arrow") <=0)
		return notify_fail("孔雀翎已经打空了。\n");
