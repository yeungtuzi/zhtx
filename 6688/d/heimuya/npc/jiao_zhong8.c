...
void create()
{
        ...
        set("gender", "男性");
        set("title",HIR "日"+HIB"月"+HIY "神教" NOR + MAG "紫衣" NOR +
"教众");
        set("nickname", nick);
