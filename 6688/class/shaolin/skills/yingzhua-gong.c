...
int valid_learn(object me)
{
	...
	if ((int)me->query("max_force") < 100)
        ...
        if ((int)me->query_skill("hunyuan-yiqi", 1) < (int)me->query_skill("yingzhua-gong", 1) - 10 && (int)me->query_skill("hunyuan-yiqi", 1) < 180)
		return notify_fail("你的混元一气功火候不够，无法掌握鹰爪功的奥秘。\n");
	return 1;
}
