...
void create()
{
      ...
      set("long",HIC"这是一间石室，东面是块打磨光滑的“大石壁”，石壁旁点燃着
...
int do_yandu(string arg)
{
       ...
       if ( me->query_skill("spells",1) < 200 )
       ...
       if ( me->query_skill("literate") ){
        ...
        me->unconcious();
              ...
              printf("你全神贯注的研读石壁上的蝌蚪文，似乎对咒术颇有心得。\n");
              me->receive_damage("sen", 100 );
              me->receive_damage("gin", 100 );
              me->add("force", -5 );
              me->add("learned_points", 1 + random(5));
              me->improve_skill("spells", wx + random(50) );
             }
}
