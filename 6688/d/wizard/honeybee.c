...
string * buglongname = ({ 
		"一条怪异的虫子。身上布满了闪闪的鳞片，发出红色的光芒。\n它盘缩着，冷眼看着世事的变化。\n",
		"一条怪异的虫子。身上布满了闪闪的鳞片，发出绿色的光芒。\n它盘缩着，冷眼看着世事的变化。\n",
		"一条怪异的虫子。身上布满了闪闪的鳞片，发出黄色的光芒。\n它盘缩着，冷眼看着世事的变化。\n",
		"一条怪异的虫子。身上布满了闪闪的鳞片，发出青色的光芒。\n它盘缩着，冷眼看着世事的变化。\n",
		"一条怪异的虫子。身上布满了闪闪的鳞片，发出兰色的光芒。\n它盘缩着，冷眼看着世事的变化。\n",
		});
...
string ask_bug()
{
	...
	int number;
	ppl = this_player();
	env = all_inventory(ppl);
	for(i=0;i<sizeof(env);i++)
	{
		if(env[i]->query("id") =="qiannian chong")
		{
			command("kick "+ppl->query("id"));
			return "你身上不是已经有了一个虫子么？还想要，真贪心啊。\n";	
		}	
	}
	if(this_object()->query("bug_number"))
	{
	  bug = new("/obj/toy/bug.c");
	  bug->move(this_player());
	  number=this_object()->query("bug_number");
	  bug->set("name",bugname[number-1]);
	  bug->set("long",buglongname[number-1]);
	  this_object()->add("bug_number",-1);
	  return "你可别告诉别人哦，这个虫子据说有神秘的力量，具体我也不大清楚。\n";
	}	
	else
	  return "虫子？什么虫子？我怎么不知道啊。\n";
}
int check_bugs()
{
	object *bugs;
	remove_call_out("check_bugs");
	bugs = filter_array(children("/obj/toy/bug"),(:clonep:));
	this_object()->set("bug_number",(5-sizeof(bugs)));
	call_out("check_bugs",900);
	return this_object()->query("bug_number");	
}
...
void create()
{
	set_name("蜜儿", ({"honeybee"}));
	set("nickname", YEL "漂亮的妹妹" NOR);
	set("long", HIC "\n她长得极美，尤其是那双眼睛，媚得直可以勾人魂魄。\n"+
	"其容色晶莹如玉，映照于红红烛光之下，娇美不可方物。\n"+
	"回眸嫣然一笑，雅如仙子下凡。眼波流转之间，\n"+
	"便把一个少年的心灵，推向梦中极美的境界。\n" NOR);
	set("title", HIC "神仙姐姐" NOR);
	set("gender", "女性");
	set("age", 23);
	set("rank_info", "神仙姐姐");
	set("max_kee", 10000);
	...
	set("chat_msg", ({
		...
		(: command("lazy") :),
		(: command("laughproud") :),
		"蜜儿无聊地绕着手绢，叹道: 唉，一个人，真没意思。\n",
		"蜜儿伸出白玉雕成一般的小手，托着下巴说: 谁想和我说说话?\n",
		"蜜儿斩钉截铁地说: 嗯，谁要敢欺负我，我就宰了他！\n",
		"蜜儿打了个呵欠，左手轻轻掩住樱桃小口，柔声道：我困了。\n",
		(: drool :),
		(: drool :),
		(: command("reclaim") :),
		(: command("reclaim") :),
...
void relay_emote(object ob, string verb)
{
	...
	{
	command ("chat 段竹快来啊，"+ ob->query("name") + "想要非礼我！\n") ;
	command("chat 哎哟，谁想得到这" + RANK_D->query_rude(ob)+"，竟也是一个好色之徒 。");
	}
	else
	{
	message_vision("\n蜜儿对$N笑道：“你我同为女儿身，再怎么喜欢也不要这样啊。”\n", ob);
	command("giggle");
   ...
   switch(random(50))
   {
    ...
    case 8:
    command("cry");
   command ("chat 段竹快来啊，"+ ob->query("name") + "想要羞辱我！\n") ;
...
varargs void drool(string msg, string who)
{
	...
	case 7:	this_object()->set("killer","蜜儿");break;
	...
	if( (strsrch(msg, "honeybee") >= 0)||(strsrch(msg, "蜜儿") >= 0))
	{	
	...
	{	
		...
		case 3:	command("chat* 蜜儿点了点头.\n");	break;
		case 4:command("chat* 蜜儿嚎啕大哭起来.\n"); break;
		case 5:command("chat* 蜜儿揉了揉哭红的眼睛，跺脚道： "+who+",你真要走了就别再回来！\n"); break;
		case 6:	command("chat* 蜜儿深深地叹了一口气 。\n");	break;
	...
	if( (strsrch(msg, "kiss") >= 0)|| (strsrch(msg, "love") >= 0)|| (strsrch(msg, "吻") >= 0)
		...
		case 3:command("chat* 蜜儿被"+who+"气得晕了过去。\n"); break;
		case 4:command("chat* 蜜儿嚎啕大哭起来.\n"); break;
		case 5:command("chat 不要这样子嘛！\n"); break;
		case 6:command("chat 非礼啊非礼！"+who+"这小流氓又来啦！\n"); break;
		case 7:command ("chat 段竹快来啊，"+ who + "想要羞辱我！\n") ;
		case 8:	command("chat* 蜜儿嘻嘻地笑了几声.\n"); break;
		case 9:	command("chat* 蜜儿很生气地撅了撅嘴。\n");	break;
		case 10:command("chat* 蜜儿无奈的耸了耸肩.\n");	break;
		case 11:command("chat 你对女孩子总是这样吗？\n"); break;
		case 12:command("chat 大哥你怎么这样？\n"); break;
		case 13:command("chat* 蜜儿嫣然一笑，说：够了够了!\n"); break;
		case 14:command("chat* 蜜儿满脸胀得通红，急道：你。。。 。\n");	break;
		case 15:command("chat 嗯，"+who+"是天底下最好的人了！\n"); break;
	                case 16:command ("chat 段竹快来啊，"+ who + "欺负我！\n") ; break;
		}
		return;
	}
	...
	{	
		...
		case 3:	command("chat* 蜜儿很生气地撅了撅嘴。\n");	break;
		...
		case 9:	command("chat* 蜜儿鄙夷地看着"+who+",恨不得"+who+"去死。\n"); break;
		case 10:command("chat* 蜜儿被"+who+"气得晕了过去。\n"); break;
		case 11:command("chat* 蜜儿忽然大声说：打倒臭泥潭，打倒风！\n"); break;
		case 12:command("chat* 蜜儿揉了揉哭红的眼睛，跺脚道： "+who+",我恨死你了！\n"); break;
		case 13:command ("chat 段竹快来啊，"+ who + "又想要羞辱我！\n") ; break;
		}
	}
	...
	{	
		...
		case 3:	command("chat* 蜜儿用手捂住鼻子，说“"+who+"说话好臭!\n");	break;
		case 4:	command("chat 你真的认为“" + msg + "”？\n"); break;
		case 5:	command("chat 我觉得你有点儿缠杂不清。\n"); break;
		case 6: command("chat 呸!\n"); break;
		case 7:	command("chat* 蜜儿怒道:你怎么知道“" + msg + "”？\n"); break;
		case 8:	command("chat "+ who+"滚出来!我要和你决斗！有胆子你就放马过来！\n"); break;
		case 9:	command("chat* 蜜儿鄙夷地看着"+who+",恨不得"+who+"去死。\n"); break;
		case 10:command("chat* 蜜儿嚎啕大哭起来.\n"); break;
		case 11:command("chat* 蜜儿揉了揉哭红的眼睛，跺脚道： "+who+"王八蛋给我滚出去！\n"); break;
	...
	{	
		...
		case 3:	command("chat* 蜜儿嫣然一笑，说：够了!\n"); break;
		case 4:	command("chat 你真的认为“" + msg + "”？\n"); break;
		case 5: command("chat* 蜜儿忽然莞尔一笑道: 你这是不是有点儿。。。？\n");break;
		case 6:    command("chat* 蜜儿回头看了"+who+"一眼，没吭声。\n");break;
		case 7: command("chat 嗯,"+who+"是一个好孩子.\n"); break;
		case 8:command("chat "+who+",你不会是想讨好我吧?\n"); break;
		case 9:command("chat* 蜜儿拱了拱手道：过奖，过奖 !\n");break;
		case 10:command("chat* 蜜儿指着"+who+"赞叹道：“"+who+"是武林第一高手！”\n");break;
		case 11:command("chat* 一朵红云飞上了蜜儿的面颊.\n");break;
		}
		return;
        }
	}
	switch(random(80)) {
		...
		case 12:	command("chat* 蜜儿深深地叹了一口气 。\n");	break;
		case 13:	command("chat* 蜜儿被"+who+"气得晕了过去 。\n");	break;
		case 14:	command("chat* 蜜儿满脸胀得通红，急道：你。。。 。\n");	break;
		case 15:    command("chat* 蜜儿咬了咬牙，怒道: 嗯，谁要再敢欺负我，我就宰了他！\n");break;
		case 16:    command("chat* 蜜儿忽然莞尔一笑道: 你这又是何苦呢？\n");break;
		case 17:    command("chat* 蜜儿打了个呵欠，左手轻轻掩住樱桃小口，柔声道：我困了。\n"); break;
		case 18:    command("chat* 蜜儿回头看了"+who+"一眼，没吭声。\n");break;
		case 19:    command("chat* 蜜儿一甩头，说：哼，我都懒得理你。\n");break;
		...
		case 24:	command("chat* 蜜儿嫣然一笑，说：够了!\n"); break;
		case 25:	command("chat 居然有人骂我是猪!\n");
			 	command("chat* 蜜儿嚎啕大哭起来.\n"); break;
        	case 26:	command ("chat 段竹快来啊，"+ who + "又来欺侮我！\n") ; break;
      		case 27:	command ("chat 我简直受不了了!\n") ; break;
        	case 28:	command ("chat 我恨不得"+who+"去死!\n") ; break;
        	case 29:	command ("chat 就你老和我过不去!\n") ; break;
        	case 30:	command ("chat 请不要打扰我好不好?\n") ; break;
   		case 31:	command ("chat* 蜜儿终于忍不住哭了起来。\n") ; break;
		case 32:	command("chat* 蜜儿鄙夷地看着"+who+",恨不得"+who+"去死。\n"); break;
		case 33:    command("chat* 蜜儿咬了咬牙，怒道: 嗯，谁要敢欺负我，我就宰了他！\n");break;
		case 34:    command("chat* 蜜儿忽然莞尔一笑道: 你这是不是有点儿。。。？\n");break;
		case 35:    command("chat* 蜜儿打了个呵欠，左手轻轻掩住樱桃小口，柔声道：我有点儿困了。\n"); break;
		case 36:    command("chat* 蜜儿回头看了"+who+"一眼，没吭声。\n");break;
		case 37:    command("chat* 蜜儿一甩头，说：哼，我都懒得理你。\n");break;
		...
		case 54:command("chat* 蜜儿对"+who+"表示衷心的感谢.\n");break;
		case 55:command("chat 不要这样子嘛！\n"); break;
		case 56:command("chat* 蜜儿拱了拱手道：过奖，过奖 !\n");break;
		case 57:command("chat* 蜜儿怒道:你怎么知道“" + msg + "”？\n"); break;
		case 58:command("chat* 蜜儿指着"+who+"赞叹道：“"+who+"是武林第一高手！”\n");break;
		case 59:command("chat* 蜜儿笑嘻嘻的看着"+who+"\n");break;
		case 60:command("chat 为什么呢?\n");break;
		case 61:command("chat 你是在说我吗？\n"); break;
		case 62:command("chat 无聊!\n");break;
		case 63:command("chat* 一朵红云飞上了蜜儿的面颊.\n");break;
		case 64:command("chat* 蜜儿是个自恋狂。\n");break;
		default:
	    if (random(10)<3) command("chat* 蜜儿很生气地撅了撅嘴.\n"); 
	    else if(random(10)<3) command("chat* 蜜儿嘻嘻地笑了几声.\n");
	    break; 
		}
	return;
	} 
	...
	{	
	   if(random(5)<3)
		...
		case 2:	command("chat* 蜜儿嘻嘻的笑了几声.\n"); break;
		case 3:command("chat* 蜜儿露出迷惑的表情.\n"); break;
		case 4:command("chat* 蜜儿嚎啕大哭起来.\n"); break;
		case 5:command("chat* 蜜儿安慰"+who+",别难过了.\n"); break;
		case 6:	command("chat* 蜜儿深深地叹了一口气 。\n");	break;
		case 7:	command("chat* 蜜儿无奈的耸了耸肩.\n");	break;
		case 8: command("chat* 蜜儿轻轻拍了拍"+who+"的头.\n"); break;
		}
		return;
        }
	}
	...
	{	
		...
		case 11:	command("chat* 蜜儿嘻嘻的笑了几声.\n"); break;
		case 12:	command("chat* 蜜儿把把头摇得跟拨浪鼓似的.\n");	break;
		case 13:	command("chat* 蜜儿哈哈大笑起来.\n"); break;
		}
		return ;
        }
	} 
		...
		case 12: command("chat* 蜜儿轻轻拍了拍"+who+"的头.\n"); break;
	...
	{	
		...
		case 3:	command("chat "+who+"笑起来真丑。\n"); 
			if(random(10)<2) command("chat* 蜜儿嘻嘻地笑了几声.\n");break;
		case 4:	command("chat* 蜜儿咯咯地笑了起来.\n");break;
		case 5:	command("chat* 蜜儿高兴地拍了拍手.\n");break;
		case 6: command("chat* 蜜儿轻轻拍了拍"+who+"的头.\n"); break;
		case 7:	command("chat* 蜜儿哈哈大笑起来.\n"); break;
		case 8: command("chat* 蜜儿说道:同喜,同喜!!!\n" );break;
		...
		case 11:drool(); break;
		case 12:drool(); break;
		case 13:command("chat* 蜜儿嘻嘻地笑了几声.\n"); break;
		case 14:command("chat* 蜜儿摇了摇头，叹道：唉，真是世风日下，人心不古啊！\n"); break;
		case 15:command("chat 我对此表示怀疑.\n"); break;
		case 16:command("chat* 蜜儿深深地叹了一口气 。\n");	break;
		case 17:command("chat* 蜜儿露出迷惑的表情.\n"); break;
		...
		switch(random(250)) {
			...
			case 2: command("chat* 蜜儿「哼」地冷笑一声。\n"); break;
			case 3: command("chat* 蜜儿懒懒地伸了伸腰。\n"); break;
			case 4: command("chat* 蜜儿气得晕了过去.\n"); break;
			case 5: command("chat  哼！\n"); break;
			case 6: command("chat* 蜜儿露出迷惑的表情.\n"); break;
			case 7: command("chat* 蜜儿忽然作了个鬼脸,说：真想出去玩会儿.\n"); break;
			...
			case 11: command("chat* 蜜儿很生气地噘了噘嘴。\n"); break;
			...
			case 18: command("chat* 蜜儿摇头叹道：这世道，还是各人自扫门前雪，休管他人瓦上霜.\n");break;
			case 19: command("chat* 蜜儿作了一个揖，说道：“各位姐妹们，大家好！”\n");break;	
			case 20: command("chat 我知道了，" + msg+"\n"); break;
			case 21:command("chat* 蜜儿露出迷惑的表情.\n"); break;
			...
			case 25: command("chat* 蜜儿无聊地绕着手绢，说：一个人，真没意思。\n"); break;
			case 26: command("chat* 蜜儿露出迷惑的表情.\n"); break;
			case 27: command("chat* 蜜儿用怀疑的眼光看了看"+who+"\n"); break;
			case 28: command("chat  我看未必.\n"); break;
			case 29: command("chat* 蜜儿奇道：是吗？\n"); break;
			case 30: command("chat  老师来啦，"+who+"你还不赶快去？\n"); break;
			case 31: command("chat "+who+",你今天怎么又逃课?\n"); break;
			case 32: command("chat* 蜜儿对所有在场的人表示感谢。\n"); break;
			case 33: command("chat* 蜜儿嘻嘻地笑了几声.\n");break;
			case 34: command("chat "+who+"说得好!\n"); break;
			case 35: command("chat* 蜜儿好奇地看着"+who+"\n"); break;
			case 36: command("chat "+who+",没想到你也会这样.\n"); break;
			case 37: command("chat* 蜜儿白了"+who+"一眼,说:你无聊不无聊啊?"); break;
			case 38:  command("chat* 蜜儿回头看了"+who+"一眼，没吭声。\n");break;
			case 39:command("chat* 蜜儿摇了摇头，叹道：唉，真是世风日下，人心不古啊！\n"); break;
			case 40:command("chat 嗯 ... " + who + "说得好！\n"); break;
			case 41:command("chat* 蜜儿无奈的耸了耸肩.\n");	break;
			case 42:command("chat 嗯，"+who+"是天底下最好的人了！\n"); break;
			case 43:command("chat* 蜜儿把把头摇得跟拨浪鼓似的.\n");	break;
			case 44:command("chat 我对此表示怀疑.\n"); break;
			case 45: command("chat 我觉得最佳表情奖应该授予"+who+".\n"); break;
			case 46: command("chat* 蜜儿轻轻拍了拍"+who+"的头.\n"); break;
			case 47: command("chat* 蜜儿笑嘻嘻的看着"+who+"\n"); break;
			...
			case 55: command("chat* 蜜儿打了"+who+"一个耳光.\n"); break;
			case 56:command("chat* 蜜儿给大家盈盈的福了一福.\n"); break; 
			case 57:command("chat 不要这样嘛!\n"); break;
			case 58:command("chat 要死啊你!"+who+"!\n"); break; 
			case 59:command("chat* 蜜儿忽然大声说：打倒臭泥潭，打倒风！\n"); break;
			case 60:command("chat* 蜜儿露出迷惑的表情.\n"); break;
			case 61:command("chat* 蜜儿振臂高呼：“我们热爱侠客行，侠客行万岁！”\n");break;
			case 62:command("chat* 蜜儿对大家摇摇头，叹道：“你们都太不要脸了。”\n");break;
			case 63:command("chat* 蜜儿点了点头.\n");	break;
			case 64:command("chat* 蜜儿哈哈大笑起来.\n"); break;
			case 65: command("chat 与其求人,不如求己!\n"); break;
			case 66:command("chat* 蜜儿失望极了!\n");break;
			case 67:command("chat 无聊!\n");break;
			case 68:command("chat 是吗?\n"); break;
		        case 69:command("chat 变态！\n"); break;
			case 70:command("chat* 蜜儿是个自恋狂。\n");break;
			case 71:command("chat 为什么？\n");break;
			case 72:command("chat 你烦不烦啊？\n");break;
			default:
	    if (random(10)<1) command("chat* 蜜儿皱了皱眉，似乎想说什么。\n");
		else if (random(10)<1) command("chat* 蜜儿嘻嘻地笑了几声.\n");
	    else if (random(10)<1) command("chat* 蜜儿懒懒的伸了伸腰.\n");
				break;
		}
	}
}
...
void greeting(object ob)
{
	...
	if(ob->query("id")=="olives")
	{
	  command("say 噢，"+ob->query("name")+"公子回来了。");
	}
	else if(ob->query("id")=="pock")
	{	say(CYN"蜜儿说道:大功告成!\n"NOR);
		command("pat shuang");
		return;
	}
...
int do_chat( string arg )
{
   ...
   if( sscanf(arg, "*kiss %s", dir)==1 ) {
		if( dir=="honeybee") {
		if(ob->query("id")=="olives") return 0;
		else
		{
...
int do_sing ( string arg )
{
   ...
   if( sscanf(arg, "for %s", dir)==1 ) {
		...
		case 1:
		message_vision(	"$N对$n嫣然一笑.\n\n",this_object(),ob );
		ob->set_temp("olivesnod",1);
		break;
		default:
		message_vision("\n蜜儿对$N笑道：“你发花痴啊，居然对机器人唱歌。”\n", ob);
...
void die()
{
        ...
        command( "say 嘻..");
	carry_object(__DIR__"obj/xiandan");
	command( "eat xiandan");
...
{
	command( "xixi");
	return("咦，你也知道他？他就是我老公拉，在这里就是EMOTE啊。。。\n ");
}
...
{	object who;
	...
	if ( !present(ob, me) ) return notify_fail("你没有这件东西。");
     if((string)ob->query("name")==MAG"紫罗兰"NOR)
	 {
	...
	{
	message_vision("\n$N缓缓地摇了摇头，柔声说道:不是段竹送我的,我不要.\n"
	+"说罢垂下头来，咬了咬牙,幽幽嗔道：死段竹，臭段竹，为什么还不回来呢?\n",this_object());
	return 0;
	}
}
