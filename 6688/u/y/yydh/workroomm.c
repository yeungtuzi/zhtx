...
int do_leave(string arg)
{
        ...
        if (arg == "west") {
                if (me->query("marks/点菜")) {
                        m = i*10000;
                        num = sprintf("%d", i);
                        tell_object(me, "小桂子阿姨笑着对你说：你点了" + num + "道菜，请你付" + m + "两银子再走。\n");
       return 1;
                }
                else {
...
{
    object ob;
    message("vision","茅山小道打开几道门说：“既然交钱了，走吧。”\n",
            this_object() );
