...
void create()
{
        set_name(HIY"圣诞"+HIM"礼盒"NOR , ({ "Christmas box", "box" }) );
        set_weight(600);
        set("no_get",1);
        set("no_drop",1);
        set("no_sell",1);
...
int open_box(string arg)
{
       ...
       tell_object(me,HIG"您得到了268000点战斗经验，188888点潜能的奖励！\n"NOR);
        tell_object(me,HIG"另外特别感谢您对这个游戏的欣赏与投入，特奖励您16点武林声望！\n"NOR);
       me->add("combat_exp", 268000);
       me->add("potential", 188888);
       me->add("wlshw", 16);
