...
{
	int damage,damage_bonus,defense_factor,absorb_vic,bounce,myexp;
...
//膂力太高的也不合适，但是这样的NPC很多
	if( damage_bonus > 400 ) damage_bonus = 400;
