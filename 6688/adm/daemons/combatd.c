...
//  鉴于现在玩家攻防指数过高，特将其降低了一个数量级，以防止溢出
//  同时提高了apply/attack和defense加乘的上限到250和150
//  2004.2.8. by masterall
...
varargs int skill_power(object ob, string skill, int usage)
{
        ...
        maxdefense= ob->query_temp("apply/defense");
                        if( maxattack > 250) maxattack = 250;
                        if( maxattack < 0) maxattack = 0;
                        if( maxdefense > 150) maxdefense = 150;
