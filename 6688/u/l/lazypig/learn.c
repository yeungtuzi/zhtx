...
int main(object me, string arg)
{
	...
	if(!arg) return notify_fail("请用 help learn 查看其用法。\n");
	...
	else  return notify_fail("请用 help learn 查看其用法。\n");
...
// change as xkx , can't learn if not master 
