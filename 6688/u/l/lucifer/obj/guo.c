...
/*
       ...
       me->set("max_atman",2000);
       me->set("combat_exp",500000);
        me->set_skill("force",400);
        me->set_skill("jiuyin-shengong",300);
       ...
       me->set_skill("xuantie-sword",200);
       me->set_skill("xianyun",200);
       me->set_skill("throwing",200);
        me->set_skill("taoism",200);
        me->set_skill("yunu-xinfa",300);
        me->set_skill("cuff",200);
        me->set_skill("strike",200);
        me->set_skill("xuantie-sword",200);
         me->set_skill("yunu-jianfa",200);
        me->set_skill("perception",200);
        me->set_skill("meinu-quan",200);
