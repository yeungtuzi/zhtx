...
string ask_eagler()
{
	...
	布般垂在背后，果然是个绝色的美女。\n");
	set("gender","女性");
	set("long","漆黑的瀑布般垂在背后，好一个绝色的美女。\n");
	obj=new("/d/hangzhou/npc/obj/book9.c");
	obj->move(ob);
		return "你很聪明，我这还有一本书，也送给你吧。\n";
}


/*int recognize_apprentice(object ob)
{
        if (!(int)ob->query_temp("learned/eagler"))  
		return 0;
        return 1;
}
