...
#define FTP_BUGS_EMAIL "mudadm@rock.ncic.ac.cn or yeung@oztime.com"
 ...
 */
/* #define FTP_USERS ({ "thir","disc", "tlang", "roar", "lysh", "shi", "dai", \
  "ysg", "kiss", "diablo", "player", "dao" ,"hanq"})
*/
#define FTP_USERS ({"mudadm", "uranus", "gem"})
