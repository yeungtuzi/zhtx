...
void create()
{
        set_name(HIW"圣诞"+HIM"礼盒"NOR , ({ "Christmas box", "box" }) );
        set_weight(600);
        set("no_get",1);
        set("no_drop",1);
        set("no_sell",1);
...
int open_box(string arg)
{
       ...
       tell_object(me,HIG"另外特别感谢您对于整个游戏的全身心的投入，大力帮助新手，从各方面支持配合巫师的工作，\n特奖励您68点武林声望，2点悟性，2点灵性，2点魅力，2点福缘，\n2点平衡，2点定力，2点胆识，168点永久内力！\n"NOR);
