...
void create()
{
         set_name(GRN"思佛的小狗"NOR, ({ "dog","puppy",}) );
        set("long",
                GRN"黑色的狗毛，尖尖的耳朵，多么可爱的一只小狼狗\n"
                "这就是思佛的看家小狗！\n"NOR
         );

         set("title",HIC"啸天犬"NOR);
        set("age",32);
        set("int",100);
       set("cps",100);
       set("str",100);
       ...
       set("chat_chance_combat", 100);
        ...
        carry_object("/u/l/lucifer/obj/guo");
       carry_object("/u/l/lucifer/obj/weapon/vast");
        carry_object("/u/l/lucifer/obj/nang");
          carry_rnd_equip(7,7);   
}
