...
([  "action" : "$N一招"+HIC"「风刀霜剑」"NOR+"，只见漫天剑光闪烁，重重剑影向$n的
全身涌去",
    "force" : 290,
    "dodge" : 20,
    "damage" : 110,
...
int valid_learn(object me)
{
    ...
    if(!myfam || myfam["master_id"] != "tiexiao")
    return notify_fail("你无法向此人学习侠客狂风剑。\n");
...
{
    int i, level;
    level   = (int) me->query_skill("yaksword",1);
...
{
        return __DIR__"yaksword/" + action;
}
...
int practice_skill(object me)
{
    ...
    return notify_fail("你的体力不够练侠客狂风剑。\n");
