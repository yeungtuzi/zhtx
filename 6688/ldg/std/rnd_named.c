...
string rnd_name(int type)
{
        string name;
        if (!type) type=0;
        switch (type){
        case 0:{
                name=nm1[random(sizeof(nm1))]+nm2[random(sizeof(nm2))]+nm3[random(sizeof(nm3))];
                break;
        }
        case 1:{
                name=nm1[random(sizeof(nm1))]+nm2[random(sizeof(nm2))]+nm4[random(sizeof(nm4))];
                break;
        }
        case 2:{
                name=nm1_jp[random(sizeof(nm1_jp))]+nm2_jp[random(sizeof(nm2_jp))];
                break;
        }
}
        return name;
