...
HIC"“苍天不负我命，终于让我等到了这一天，好孩子，这把圣火令今后就交给你了！”\n",NOR,
HIR"“一定要好好珍惜他，剑在人在，剑亡人亡！”\n",NOR,
HIG"“听说我的师兄飞雪后来归隐去了侠客岛，如果有机会的话将来你去找他”\n",NOR,
...
void create()
{
        ...
        set_skill("shenghuo-shengong",220);
        set_skill("qishang-quan",220);
        set_skill("yueying-wubu",220);
        set_skill("dodge",220);
...
void die()
{
       ...
       command("sigh");
       if(me->query_skill("shenghuo-shengong",1) > 199) 
       {
       me->remove_all_enemy();
       ob->remove_all_enemy();
       "/cmds/imm/full"->main(ob,"");
...
{        
        object weapon = new("/d/qiankun/obj/weapon/shenghuoling");       
        object ob;        
        ...
        if( ++stage < sizeof(msg_weapon) ) 
        {
                ...
                if (who->query_temp("mpweapon_win") && !objectp(ob = present("shenghuo ling",who) )) 
                {
                weapon->move(who);
                }
