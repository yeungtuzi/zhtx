...
void create()
{
	set_name(HIG"辉月使"NOR, ({ "huiyue shi", "huiyue" }) );
	set("gender", "女性" );
	...
	carry_object(__DIR__"obj/heibaipao")->wear();
      	carry_object(__DIR__"obj/ling1")->wield();
      	carry_object(__DIR__"obj/ling2")->wield();
}
...
void die()
{
	...
	if( killer->query_temp("marks/daiyisi") )
		killer->set_temp("marks/huiyue",1);
	::die();
}
...
int do_killing(string arg)
{
	...
	{	
		...
		if(name == "miaofeng shi" || name == "liuyun shi")
		{
