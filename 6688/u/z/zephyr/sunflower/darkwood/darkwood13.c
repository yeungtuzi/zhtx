...
void reset()
{
        ::reset();
        set("exits", ([ 
          "south" : __DIR__"darkwood" + (random(3)+7),
          "east" : __DIR__"darkwood25",
          "west" : __DIR__"darkwood" + (random(3)+7),
          "north" : __DIR__"darkwood" + (random(3)+7),
          "southeast" : __DIR__"darkwood" + (random(3)+7),
          "southwest" : __DIR__"darkwood" + (random(3)+7),
          "northwest" : __DIR__"darkwood12",
          "northeast" : __DIR__"darkwood" + (random(3)+7),
        ]));
}
