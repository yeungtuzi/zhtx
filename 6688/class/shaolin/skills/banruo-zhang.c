...
{ 
        ...
        if ((int)me->query("force") < 20)
         ...
         if ((int)me->query_skill("hunyuan-yiqi", 1) < (int)me->query_skill("banruo-zhang", 1) - 10 && (int)me->query_skill("hunyuan-yiqi", 1) < 220)
                return notify_fail("你的混元一气功火候不够，无法掌握般若掌的奥秘。\n");
...
{
         return CLASS_D("shaolin") + "/skills/banruo-zhang/" + action;
}
