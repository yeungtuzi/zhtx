...
string wall_skill = "blade";
string wall_skill_cn = "刀";

void create()
{
        set("short","神"+wall_skill_cn+"阁");
        set("long", @LONG
...
LONG
        ...
        set("exits", ([
		"east"  :__DIR__"dingfeng12",
		"west"  :__DIR__"goutang",
        ]));
        set("objects",([
                __DIR__"npc/huaxiangrong" : 1,
        ]));
...
int do_canxiu(string arg)
{
	...
	if( me->query("gin") < 50 )
     ...
     me->receive_damage("gin", 30);
        me->improve_skill(wall_skill, (me->query_int()));
