...
LONG NOR);
		...
		set("objects", ([
		__DIR__"npc/assassin.c" : 1,
		__DIR__"npc/assassin2.c" : 1,
		__DIR__"npc/assassin3.c" : 1,
...
void reset()
{
        ::reset();
        set("exits", ([ 
          "south" : __DIR__"darkwood" + (random(3)+11),
          "east" : __DIR__"darkwood" + (random(3)+11),
          "west" : __DIR__"darkwood" + (random(3)+11),
          "north" : __DIR__"darkwood" + (random(3)+11),
          "southeast" : __DIR__"darkwood" + (random(3)+11),
          "southwest" : __DIR__"darkwood" + (random(3)+11),
          "northwest" : __DIR__"darkwood6",
          "northeast" : __DIR__"darkwood" + (random(3)+11),
        ]));
}
