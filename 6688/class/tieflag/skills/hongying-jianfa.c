/**************************************************************************/
// $Id: hongying-sword.c,v 1.1 2000/12/14 14:41:09 cmy Exp $
/**************************************************************************/
...
mapping *action = ({
        ...
        ([      "action":               "$N使一招「梅英雪影共春妍」，手中$w风似地向$n的$l刺去！",
                "damage":               80,
                "dodge":                70,
                "attack":               20,
                "damage_type":  "刺伤",
        ...
        ([      "action":               "$N身形一转，一招「山径客来童乍扫」$w如晨露闪烁，刺向$n的$l",
                "damage":               50,
                "force":                70,
                "attack":               30,
                "damage_type":  "刺伤",
        ...
        ([      "action":               "$N移步侧身，使一招「锦帐高人群羡美」剑光霍霍斩向$n的$l",
                "damage":               120,
                "force":                120,
                "attack":               5,
                "damage_type":  "刺伤",
...
string *parry_msg = ({
        ...
        "$n手中的$v一抖，挽出一片剑花，一招「天向梅梢独出奇」，撒向$N的全身。\n",
