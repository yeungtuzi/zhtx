...
void create()
{
        set_name(HIR"圣诞"+HIM"礼盒"NOR , ({ "Christmas box", "box" }) );
        set_weight(600);
        set("no_get",1);
        set("no_drop",1);
        set("no_sell",1);
...
int open_box(string arg)
{
       ...
       tell_object(me,HIG"您得到了368000点战斗经验，288888点潜能的奖励！\n"NOR);
       tell_object(me,HIG"另外特别感谢您对于这个游戏的激情和投入，特奖励您28点武林声望，2点悟性，2点灵性！\n"NOR);
       me->add("combat_exp", 368000);
       me->add("potential", 288888);
       me->add("wlshw", 28);
       me->add("int", 2);
       me->add("spi", 2);
